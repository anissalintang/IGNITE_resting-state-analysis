...
for i = 1:numel(names)
    ...
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_AC_lh.txt'];
...
for i = 1:numel(names)
    ...
    % Define the path to the txt file for the current name
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_HG_lh.txt'];
...
for i = 1:numel(names)
    ...
    % Define the path to the txt file for the current name
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_MGB_lh.txt'];
...
for i = 1:numel(names)
    ...
    % Define the path to the txt file for the current name
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_PT_lh.txt'];
...
for i = 1:numel(names)
    ...
    % Define the path to the txt file for the current name
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_V1_lh.txt'];
...
for i = 1:numel(names)
    ...
    % Define the path to the txt file for the current name
    txt_file_path = [name_folder_path, names{i}, '_meanALFF_thalamus_lh.txt'];
...
writecell(allSubs_ALFF_AC, [compare_ALFF_path, 'allSubs_meanALFF_AC_lh.txt'], ...
    'Delimiter', ' ');
writecell(allSubs_ALFF_HG, [compare_ALFF_path, 'allSubs_meanALFF_HG_lh.txt'], ...
    'Delimiter', ' ');
writecell(allSubs_ALFF_PT, [compare_ALFF_path, 'allSubs_meanALFF_PT_lh.txt'], ...
    'Delimiter', ' ');
writecell(allSubs_ALFF_V1, [compare_ALFF_path, 'allSubs_meanALFF_V1_lh.txt'], ...
    'Delimiter', ' ');
writecell(allSubs_ALFF_MGB, [compare_ALFF_path, 'allSubs_meanALFF_MGB_lh.txt'], ...
    'Delimiter', ' ');
writecell(allSubs_ALFF_thalamus, [compare_ALFF_path, 'allSubs_meanALFF_thalamus_lh.txt'], ...
    'Delimiter', ' ');
...
writecell(sub_HL_ALFF_AC, [compare_ALFF_path, 'sub_HL_meanALFF_AC_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_HL_ALFF_HG, [compare_ALFF_path, 'sub_HL_meanALFF_HG_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_HL_ALFF_PT, [compare_ALFF_path, 'sub_HL_meanALFF_PT_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_HL_ALFF_V1, [compare_ALFF_path, 'sub_HL_meanALFF_V1_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_HL_ALFF_MGB, [compare_ALFF_path, 'sub_HL_meanALFF_MGB_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_HL_ALFF_thalamus, [compare_ALFF_path, 'sub_HL_meanALFF_thalamus_lh.txt'], ...
    'Delimiter', ' ');
...
writecell(sub_NH_ALFF_AC, [compare_ALFF_path, 'sub_NH_meanALFF_AC_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_NH_ALFF_HG, [compare_ALFF_path, 'sub_NH_meanALFF_HG_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_NH_ALFF_PT, [compare_ALFF_path, 'sub_NH_meanALFF_PT_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_NH_ALFF_V1, [compare_ALFF_path, 'sub_NH_meanALFF_V1_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_NH_ALFF_MGB, [compare_ALFF_path, 'sub_NH_meanALFF_MGB_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_NH_ALFF_thalamus, [compare_ALFF_path, 'sub_NH_meanALFF_thalamus_lh.txt'], ...
    'Delimiter', ' ');
...
writecell(sub_tin_HL_ALFF_AC, [compare_ALFF_path, 'sub_tin_HL_meanALFF_AC_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_HL_ALFF_HG, [compare_ALFF_path, 'sub_tin_HL_meanALFF_HG_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_HL_ALFF_PT, [compare_ALFF_path, 'sub_tin_HL_meanALFF_PT_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_HL_ALFF_V1, [compare_ALFF_path, 'sub_tin_HL_meanALFF_V1_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_HL_ALFF_MGB, [compare_ALFF_path, 'sub_tin_HL_meanALFF_MGB_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_HL_ALFF_thalamus, [compare_ALFF_path, 'sub_tin_HL_meanALFF_thalamus_lh.txt'], ...
    'Delimiter', ' ');
...
writecell(sub_tin_NH_ALFF_AC, [compare_ALFF_path, 'sub_tin_NH_meanALFF_AC_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_NH_ALFF_HG, [compare_ALFF_path, 'sub_tin_NH_meanALFF_HG_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_NH_ALFF_PT, [compare_ALFF_path, 'sub_tin_NH_meanALFF_PT_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_NH_ALFF_V1, [compare_ALFF_path, 'sub_tin_NH_meanALFF_V1_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_NH_ALFF_MGB, [compare_ALFF_path, 'sub_tin_NH_meanALFF_MGB_lh.txt'], ...
    'Delimiter', ' ');
writecell(sub_tin_NH_ALFF_thalamus, [compare_ALFF_path, 'sub_tin_NH_meanALFF_thalamus_lh.txt'], ...
    'Delimiter', ' ');
